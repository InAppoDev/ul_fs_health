...
@RoutePage()
class GPAQTravelInitialScreen extends StatelessWidget {
  const GPAQTravelInitialScreen({super.key, this.shouldAuthenticate = false});


  final bool shouldAuthenticate;
  @override
  Widget build(BuildContext context) {
    return GPAQTravelInitialContent(shouldAuthenticate: shouldAuthenticate);
  }
}

class GPAQTravelInitialContent extends StatelessWidget {
  const GPAQTravelInitialContent({super.key, required this.shouldAuthenticate});
