  ...
  Widget build(BuildContext context) {
    return QuestionnaireWidget(
      onNavigate: (context) {
        ...
        context.router.push(GPAQTravelInitialRoute(shouldAuthenticate: widget.shouldAuthenticate));
      },
      child: Scaffold(
            ...
            builder: (context, state) => RowActionsWidget(
                ...
                onRightPress: () {
                  context.read<QuestionnaireSubmitterBloc>().add(
                      QuestionnaireSubmitterEvent.submitWork(
                          workData: QuestionnaireModel.from(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        RowActionsWidget(
                            ...
                            rightTitleColor:
                                context.watch<QuestionnaireBloc>().state.workData.hasActivity ==
                                        false
                                    ? ColorScheme.of(context).onPrimary
                                    : ColorScheme.of(context).onSecondary,
                            leftBackgroundColor:
