...
class MahonyFilter { // 2 * proportional gain (Kp), (2.0 * 0.5) = 1.0
  ...
  final double _defaultFrequency = 512.0; // (1.0 / 512.0) sample frequency in Hz
  ...
  void update(
    ...
    gx *= 0.5 * _sampleFrequency; // pre-multiply common factors
    gy *= 0.5 * _sampleFrequency;
    gz *= 0.5 * _sampleFrequency;
    pa = q2;
    pb = q3;
    pc = q4;
